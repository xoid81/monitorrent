...
@pytest.mark.parametrize('date_string,expected', [
    ("9 января 1985 в 02:00", datetime(1985, 1, 9, 2, 00)),
    ("12 февраля 2017 в 22:37", datetime(2017, 2, 12, 22, 37)),
    ("2 марта 1992 в 14:59", datetime(1992, 3, 2, 14, 59)),
    ("1 апреля 2017 в 1:37", datetime(2017, 4, 1, 1, 37)),
    ("9 мая 2017 в 12:34", datetime(2017, 5, 9, 12, 34)),
    ("29 июня 2017 в 00:00", datetime(2017, 6, 29, 0, 0)),
    ("4 июля 2015 в 0:0", datetime(2015, 7, 4, 0, 0)),
    ("17 августа 2017 в 1:23", datetime(2017, 8, 17, 1, 23)),
    ("01 сентября 2017 в 14:48", datetime(2017, 9, 1, 14, 48)),
    ("10 октября 2017 в 11:11", datetime(2017, 10, 10, 11, 11)),
    ("5 ноября 2017 в 17:17", datetime(2017, 11, 5, 17, 17)),
    ("24 декабря 1991 в 23:59", datetime(1991, 12, 24, 23, 59)),
])
...
@pytest.mark.parametrize('date_string,delta_days,expected_time', [
    ("вчера в 02:00", -1, time(2, 0)),
    ("сегодня в 22:37", 0, time(22, 37)),
])
...
@pytest.mark.parametrize('date_string', ["когда-то", "не сегодня", "не вчера", "12 небритебря 27916 в 31:31"])
